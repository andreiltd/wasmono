...
Probably the easiest way of getting buck2 is via dotslash (https://dotslash-cli.com). 
This will also ensure using the buck2 version that the rules were tested against.
